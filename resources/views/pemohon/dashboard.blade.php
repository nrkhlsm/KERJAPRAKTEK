        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            <div id="timeline">
                ...
                <div class="alert alert-danger" role="alert">
                    ...
                    <p>Apabila status masih berwarna kuning berarti masih diproses, namun apabila sudah berwarna hijau berarti akta sudah jadi dan dapat diambil ke kantor notaris.</p>
                    <hr>
                    <p class="mb-0">Kantor : Jl. Agung Barat IX, Blok B9, No. 1, Sunter Podomoro, Jakarta Utara 14350 </p>
                    <p>Telp. 0811-1640-706 Fax. 021-29460240</p>
                </div>
            </div>
