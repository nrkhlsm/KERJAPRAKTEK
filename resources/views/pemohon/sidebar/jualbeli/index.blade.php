		...
		<div class="col-12">
			<div class="card">
				<div class="card-content">
					<div class="card-body">
						<h4 class="card-title">Semua Data Pengajuan Akta Jual Beli</h4>
						<div style="width: auto; overflow: auto">
							<table id="example" class="display" style="width:100%" class="overflow-y">
								<thead>
									<tr>
										<th>No</th>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="{{ route('jualbeli.edit', $key->id) }}" type="button"
