...
<section>
    <div class="row">
        <div class="col-4">
            <div class="card">
                <a class="btn btn-primary btn-lg" href="{{ route('perseroanterbatas.create') }}">Ajukan Permohonan</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title">Semua Data Pengajuan Akta Perseroan Terbatas </h4>
                        <table id="example" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($key->encrypt =='0')
                                        <a class="btn btn-danger btn-sm" href="{{ route('rsa.persero.command.decyprt', [$key->id, 2]) }}">Terenkripsi</a>
                                        @else
                                        <a class="btn btn-success btn-sm" href="{{ route('rsa.persero.command.encrpty', [$key->id, 2]) }}">Terdekripsi</a>
                                        @endif
                                    </td>
                                    <td>
                                        @if($key->status)
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('perseroanterbatas.edit', $key->id) }}" type="button" class="btn btn-info btn-sm">
