...
<body>
    <div class="d-flex justify-content-center">
        <img src="{{ base_path('public/images/kop.svg') }}" alt="" class="mx-auto d-block">
    </div>
    <!-- <img src="{{ base_path('public/storage/documents/'.$user->id.'/perseroankomanditer/'.$pesanan->ktp) }}" alt=""> -->
</body>
