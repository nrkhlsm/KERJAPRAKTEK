 ...
 .w-30-percen {
   ...
   <body class="margin-paper-1">
      <table class="kop-surat">
         <tr>
            <td> <span class="font-size-7">DAFTAR PENGAJUAN AKTA PERSEROAN TERBATAS</span></td>
         </tr>
      </table>
     <span class="font-size-7">Tanggal cetak: {{ $dateNow }}<span></td>
      <table class="table custom-table-0 font-size-7">
         ...
         <tbody>
            ...
            $i=1;    
            @endphp
            @foreach ($PerseroanTerbatas as $item)
            <tr>
               <td>{{ $i++ }}</td>
               <td>{{ $item['nama_pt'] }}</td>
               <td>{{ $item['alamat'] }}</td>
      ...
      <table class="table table-borderless font-size-7 pt-5">
         <tbody class="text-center">
            <tr>
               <td width="40%"> </td>
               <td></td>
               <td width="40%">Jakarta,<br><br>Penanggung Jawab<br><br><br><br><br> <span><u></u></span><br> {{ $user['name'] }}<br></td>
            </tr>
            <tr>
               <td></td>
               <td width="20%"> </td>
